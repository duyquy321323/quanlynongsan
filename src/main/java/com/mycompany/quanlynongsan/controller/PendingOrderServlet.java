...
public class PendingOrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (status.equals("pending")) {
            ...
            List<OrderRepository.OrderSummary> confirmedOrders = OrderRepository.getConfirmedOrdersBySeller(currentUser.getUserId());
            ...
            List<OrderRepository.OrderSummary> successfulOrders = OrderRepository.getSuccessfulOrdersBySeller(currentUser.getUserId());
            ...
            List<OrderRepository.OrderSummary> canceledOrders = OrderRepository.getCanceledOrdersBySeller(currentUser.getUserId());
